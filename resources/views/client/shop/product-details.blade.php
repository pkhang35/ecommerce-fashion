            ...
            <div class="col-lg-6">
                ...
                <div class="gallery-view">
                    ...
                    <div class="gallery-main-image products__gallery-img--lg">
                        <img class="product-main-image" src="{{ asset($imageProduct) }}"
                            alt="Slide 01" />
                    </div>
                </div>
            </div>
                    ...
                    <div class="row products-tab__description">
                        ...
                        <div class="col-lg-5 order-lg-0 order-1">
                            <div class="products-video">
                                ...
                                <a href="https://youtu.be/qzyL9SJ30do?si=E5VEniUR_5ih0TID" class="play-icon venobox" data-autoplay="true"
                                    data-vbtype="video">
                                    <span>
                            ...
                            <div class="cards-md__info d-flex justify-content-between align-items-center">
                                <a href="product-details.html" class="cards-md__info-left">
                                    ...
                                    <div class="cards-md__info-price">
                                        <span class="font-body--lg-500">Giá: {{ number_format($product['price'], 0, ',', '.') }} VND</span>                                         
                                    </div>
                                    <div class="cards-md__info-price">
                                        <span class="font-body--lg-500">Số lượng: {{ $product['quantity'] }}</span>                                         
                                    </div>
